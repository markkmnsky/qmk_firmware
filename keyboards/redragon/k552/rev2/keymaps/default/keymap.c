...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = { {   KC_ESC,     KC_F1,      KC_F2,      KC_F3,   KC_F4,      KC_F5,   KC_MPRV,   KC_MPLY,    KC_MNXT,    KC_MUTE,    KC_VOLD,    KC_VOLU,    RGB_TOG,     KC_NO,      KC_PSCR,    KC_SLCK,    KC_PAUSE },
    ...
    [_FN]   = { {   RESET,      _______,    _______,    _______, _______,    _______, KC_F6,   KC_F7,      KC_F8,      KC_F19,     KC_F10,      KC_F11,     KC_F12,    _______,    _______,    _______,    KC_SLEP  },
